              ...
              >
                ...
                >
                  ...
                  <div className="flex flex-row items-center space-x-2">
                    ...
                    <p className="text-xs font-normal text-[#474c54]">
                      Kitchen
                    </p>
                  </div>
                </div>
                <div className="flex flex-col items-center justify-between">
                  <svg
                    onClick={() => inCreament(curr.id)}
                    xmlns="http://www.w3.org/2000/svg"
                    fill="none"
                    viewBox="0 0 24 24"
                    stroke-width="1.5"
                    stroke="currentColor"
                    class="cursor-pointer w-6 h-6 bg-[#0e1227] rounded-sm p-1 "
                  >
                    <path
                      stroke-linecap="round"
                      stroke-linejoin="round"
